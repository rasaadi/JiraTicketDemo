...
#
# [docs]    def find(self, resource_format, ids=None):
...
#
#
# [docs]    def async_do(self, size=10):
...
#
#     # non-resource
# [docs]    def application_properties(self, key=None):
...
#
#
# [docs]    def set_application_property(self, key, value):
...
#
#
# [docs]    def applicationlinks(self, cached=True):
...
#
#
# [docs]    def delete_attachment(self, id):
...
#
#
# [docs]    def component_count_related_issues(self, id):
...
#
#
# [docs]    def delete_component(self, id):
...
#
# [docs]    def custom_field_option(self, id):
...
#     # Dashboards
#
# [docs]    def dashboards(self, filter=None, startAt=0, maxResults=20):
...
#
#
# [docs]    def favourite_filters(self):
...
#
#
# [docs]    def create_filter(self, name=None, description=None,
...
#
#
# [docs]    def update_filter(self, filter_id,
...
#     # Groups
#
# [docs]    def group(self, id, expand=None):
...
#
#     # non-resource
# [docs]    def groups(self, query=None, exclude=None, maxResults=9999):
...
#
#
# [docs]    def group_members(self, group):
...
#     # Issues
#
# [docs]    def issue(self, id, fields=None, expand=None):
...
#
#
# [docs]    def create_issue(self, fields=None, prefetch=True, **fieldargs):
...
#
#
# [docs]    def create_issues(self, field_list, prefetch=True):
...
#
#
# [docs]    def supports_service_desk(self):
...
#
#
# [docs]    def create_customer(self, email, displayName):
...
#
#
# [docs]    def create_customer_request(self, fields=None, prefetch=True, **fieldargs):
...
# [docs]    def add_remote_link(self, issue, destination, globalId=None, application=None, relationship=None):
...
#
#
# [docs]    def add_simple_link(self, issue, object):
...
#
#
# [docs]    def find_transitionid_by_name(self, issue, transition_name):
...
#
#
# [docs]    def delete_issue_link(self, id):
...
#     # Issue link types
#
# [docs]    def issue_link_types(self, force=False):
...
#
#
# [docs]    def issue_link_type(self, id):
...
#
#
# [docs]    def issue_type_by_name(self, name):
#         """
...
#
#
# [docs]    def request_types(self, service_desk):
...
#
#
# [docs]    def request_type_by_name(self, service_desk, name):
...
#
#     # Security levels
# [docs]    def security_level(self, id):
...
#     # Category
#
# [docs]    def statuscategories(self):
...
#
#
# [docs]    def statuscategory(self, id):
...
#     # Users
#
# [docs]    def user(self, id, expand=None):
...
#
#
# [docs]    def search_assignable_users_for_projects(self, username, projectKeys, startAt=0, maxResults=50):
...
#
#
# [docs]    def search_assignable_users_for_issues(self,
#                                            username,
#                                            project=None,
#                                            issueKey=None,
#                                            expand=None,
...
#
#     # non-resource
# [docs]    def user_avatars(self, username):
...
#
#
# [docs]    def create_temp_user_avatar(self,
#                                 user,
#                                 filename,
#                                 size,
#                                 avatar_img,
...
#
#
# [docs]    def confirm_user_avatar(self, user, cropping_properties):
#         """Confirm the temporary avatar image previously uploaded with the specified cropping.
#
...
#
#
# [docs]    def set_user_avatar(self, username, avatar):
#         """Set a user's avatar.
#
...
#
#
# [docs]    def delete_user_avatar(self, username, avatar):
...
#
#
# [docs]    def search_users(self, user, startAt=0, maxResults=50, includeActive=True, includeInactive=False):
...
#
#
# [docs]    def search_allowed_users_for_issue(self, user, issueKey=None, projectKey=None, startAt=0, maxResults=50):
...
#
#
# [docs]    def move_version(self, id, after=None, position=None):
...
#
#
# [docs]    def version(self, id, expand=None):
...
#
#
# [docs]    def version_count_related_issues(self, id):
...
#
#
# [docs]    def version_count_unresolved_issues(self, id):
...
#
# [docs]    def session(self, auth=None):
...
#                 return None
#
# [docs]    def rename_user(self, old_user, new_user):
#         """Rename a JIRA user.
#
...
#
#
# [docs]    def deactivate_user(self, username):
...
#
#
# [docs]    def reindex(self, force=False, background=True):
...
#
#
# [docs]    def backup(self, filename='backup.zip', attachments=False):
...
#
#
# [docs]    def backup_download(self, filename=None):
...
#
#
# [docs]    def delete_project(self, pid):
...
#
#
# [docs]    def create_project(self, key, name=None, assignee=None, type="software", template_name=None):
...
#
#
# [docs]    def add_user_to_group(self, username, group):
...
#
#
# [docs]    def remove_user_from_group(self, username, groupname):
...
# [docs]    def get_igrid(self, issueid, customfield, schemeid):
...
#
#
# [docs]    def sprints_by_name(self, id, extended=False):
#         sprints = {}
...
#
#
# [docs]    def update_sprint(self, id, name=None, startDate=None, endDate=None, state=None):
#         payload = {}
#         if name:
#             payload['name'] = name
#         if startDate:
...
#
#
# [docs]    def incompletedIssuesEstimateSum(self, board_id, sprint_id):
...
#
#
# [docs]    def removed_issues(self, board_id, sprint_id):
...
#
#
# [docs]    def removedIssuesEstimateSum(self, board_id, sprint_id):
#         """Return the total incompleted points this sprint."""
#         return self._get_json('rapid/charts/sprintreport?rapidViewId=%s&sprintId=%s' % (board_id, sprint_id),
...
# [docs]    def sprint_info(self, board_id, sprint_id):
...
# [docs]    def delete_board(self, id):
#         """Delete an agile board."""
#         board = Board(self._options, self._session, raw={'id': id})
#         board.delete()
#
#
# [docs]    def create_board(self, name, project_ids, preset="scrum",
...
#
#
# [docs]    def create_sprint(self, name, board_id, startDate=None, endDate=None):
...
#
#
# [docs]    def add_issues_to_sprint(self, sprint_id, issue_keys):
...
#
#
# [docs]    def add_issues_to_epic(self, epic_id, issue_keys, ignore_epics=True):
...
# [docs]    def rank(self, issue, next_issue):
...
#
#
# [docs]    def move_to_backlog(self, issue_keys):
